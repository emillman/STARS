...
% analysis results
function [] = featureReport( features, ... % feature names to report analysis results for
                            ...
                            plot_cdf, ... % draw CDF instead of PDF when plotting mode distributions   
    ...
    % replicate the file for the log_display to all contexts.
    ...
    if make_tables
        ...
        tableFeatureResults( features, infos, cdfs, min_samples );
    end
            ...
            for c = 1:size(sources,2)
                if isstruct(infos{n}{r,c}) && infos{n}{r,c}.ergodic
                    ...
                    if infos{n}{r,c}.ergodic
                        hold on;
                        plotModeDistribution( cdfs{n}{r,c}, infos{n}{r,c}, sources{r,c}{4}, plot_cdf, max_modes, min_samples );
                        if infos{n}{r,c}.ergodic
